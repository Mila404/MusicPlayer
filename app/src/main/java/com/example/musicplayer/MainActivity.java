...
//    mp_array[].start()
    ...
    public void repeat(View view) {
        if (mp_array[position].isLooping()){
            mp_array[position].setLooping(false);
            Toast.makeText(this, "Repetir: Off", Toast.LENGTH_SHORT).show();
        }else{
            mp_array[position].setLooping(true);
            Toast.makeText(this, "Repetir: On", Toast.LENGTH_SHORT).show();
        }
    }
